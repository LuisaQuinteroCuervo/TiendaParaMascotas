...
const AdminVistaProductos = () => {
  ...
  return (
    <div className="VistaProduct">
      ...
      <h2 className="tituloAgregar">Vista Del Producto</h2>
      <br />
          ...
          <div className="col-lg-2">
            ...
            <div className="input-group">
              ...
              <span className="input-group-btn" >
                <button
                  type="button"
                  className="quantity-right-plus btn btn-successs btn-number"
                  onClick={handlePlus}
                >
...
export default AdminVistaProductos;
